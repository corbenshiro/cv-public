...
\begin{document}
	...
	\begin{cvsection}{Personal Summary}
		\begin{cvsubsection}{}{}{}
			\begin{itemize}
				...
				\item I'm very thorough in regard to my interests in IT, therefore I've acquired many skills that revolve around computing (including subcategories of cybersecurity, system administration/engineering and technical writing).
			\end{itemize}
		\end{cvsubsection}
		\begin{cvsubsection}{Verified Boot}{}{}	
			\begin{itemize}
				...
				\begin{itemize}
					...
					\item iOS/iPadOS
					\item macOS
					\item Windows NT (preferably Windows 10 (with STIGs implemented) on a Secured-core PC)
					\item Qubes OS (with the Anti Evil Maid module explicitly installed and enabled (although this method risks USB exposure to dom0))
				\end{itemize}
			\end{itemize}
		\end{cvsubsection}
		...
		\begin{cvsubsection}{Virtualization-based Security}{}{}
			\begin{itemize}
				\item The Windows NT host becomes its own VM, thus ensuring memory integrity via Hypervisor-Enforced Code Integrity.
				\begin{itemize}
		...
		\begin{cvsubsection}{STIGs}{}{}
			\begin{itemize}
				\item Windows 10 V2R2
				\item Windows Server 2019 V2R2
				\item Windows Defender Antivirus V2R2
				\item Windows Firewall V1R7
				\item Microsoft Office 2019/Office 365 Pro Plus V1R3
		...
		\begin{cvsubsection}{Typesetting Automation}{}{}
			\begin{itemize}
				...
				\begin{itemize}
					\item Lua\TeX
					\item Lua\LaTeX\ (this curriculum vitæ is declared in this \TeX\ distribution and compiled against it)
				\end{itemize}
			\end{itemize}
		\end{cvsubsection}
	\end{cvsection}
	...
	\begin{cvsection}{Extracurricular Interests}
		\begin{cvsubsection}{Sports and Fitness}{}{}
			...
			\end{itemize}
		\end{cvsubsection}
		\begin{cvsubsection}{Fiction}{}{}
			\begin{itemize}
				\item Devilman
				\item The Untamed (xianxia series based on Mo Dao Zu Shi)
				\item Noita
				\item Warhammer 40K
			\end{itemize}
		\end{cvsubsection}
